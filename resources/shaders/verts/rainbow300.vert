...
//The vertex shader should output the normalized vertex normal as vec3.
...
void main() {
  ...
  //output vertex normals as a vec3 normalized using normalize. [https://docs.gl/sl4/normalize]
  outVertexNormalVec3 = vec3(normalize(aVertexNormals));
